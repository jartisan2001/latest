# ${favorite.name} <#list github.releases as release>${release}<#if release_has_next>,</#if></#list>   发布 ，java json 类库
...
<!-- 
## 关注公众号
![微信公众号](https://avatars3.githubusercontent.com/u/32104984?s=400&u=e47a24b8cc8e7fbe2dd2f8b41ba5ca61d6d4a62e&v=4) 
-->
